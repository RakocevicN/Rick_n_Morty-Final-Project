...
from test_data.id import id_positive_expected_data, negative_id_expected_data


class TestRMAid:
    """Test for the Rick and Morty API."""

    @pytest.mark.parametrize("character_id, expected_data", id_positive_expected_data.items())
