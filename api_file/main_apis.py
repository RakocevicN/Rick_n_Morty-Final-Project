...
def verify_api_request(url):
    try:
        ...
        raise Exception(f"HTTP error occurred while fetching data: {http_err}") from http_err
    except requests.exceptions.RequestException as req_err:
        raise Exception(f"An error occurred while sending the request: {req_err}") from req_err
    except Exception as error:
        raise Exception(f"An unexpected error occurred: {error}") from error
